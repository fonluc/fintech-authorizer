...
4. [Refatoração e Correção das Funcionalidades L1, L2 e L3](#refatoração-e-correção-das-funcionalidades-l1-l2-e-l3)
...
# **Refatoração e Correção das Funcionalidades L1, L2 e L3**

## **Objetivo:**

Garantir que as funcionalidades L1 (Autorizador Simples), L2 (Autorizador com Fallback), e L3 (Dependente do Comerciante) estejam funcionando corretamente, de acordo com os requisitos do desafio.
...
- **`TransactionProcessorTest.kt` e `TransactionFallbackProcessorTest.kt`:**
  - Foram atualizados para incluir verificações detalhadas de cenários onde o saldo da categoria é insuficiente e o restante deve ser deduzido de **CASH**.
  - Novos casos de teste foram implementados para garantir a rejeição correta de transações quando os saldos são insuficientes.
